...
import 'mention_overlay_menu_group.dart';
...
extension _StartWithsSort on List<MentionOverlayResult> {
...
class MentionOverlayHandler extends StatefulWidget {
  ...
  final List<MentionOverlayResult> results;
...
class _MentionOverlayHandlerState extends State<MentionOverlayHandler> {
  final _focusNode = FocusNode(debugLabel: 'mention_overlay_menu_handler');
  final _scrollController = ScrollController();

  late List<MentionOverlayResult> results = widget.results;
  ...
  Future<void> _doSearch() async {
    final List<MentionOverlayResult> newResults = [];
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: noResults
              ? const SizedBox(
                  width: 150,
                  child: FlowyText.regular("No results found"),
                )
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: results
                        ...
                        .mapIndexed(
                          (index, group) => MentionOverlayGroup(
                            result: group,
  ...
  MentionOverlayMenuItem handlerOf(int groupIndex, int handlerIndex) =>
